    ...
    internal static class Extensions
    {
        ...
        public static IDictionary<string, string> ParseQueryString(string queryString)
        {
            ...
            foreach (var part in parts)
            {
                ...
                {
                    result[part.Substring(0, index)] = WebUtility.UrlDecode(part.Substring(index + 1));
                }
            }
        ...
        public static string BuildQueryString(IDictionary<string, string> values)
        {
            ...
            foreach (var value in values)
            {
                ...
                sb.Append(WebUtility.UrlEncode(value.Key));
                sb.Append('=');
        ...
        public static IDictionary<string, object> JsonDeserialize(string json)
        {
            ...
            object obj = Newtonsoft.Json.JsonConvert.DeserializeObject<IDictionary<string, object>>(json);
